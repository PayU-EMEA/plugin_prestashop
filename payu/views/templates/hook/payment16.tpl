...
<fieldset class="payu-payment-fieldset-1-6">
    ...
    {/if}
    {if $showApplePayPayment == true}
        <div class="row">
            <div class="col-xs-12">
                <p class="payment_module">
                    <a class="payu payu_apple_pay payment_open" data-payment="jp" href=""
                       title="{l s='Pay by Apple Pay' mod='payu'}">
                        {l s='Pay by Apple Pay' mod='payu'}
                    </a>
                </p>

                <div class="payment_module_content" style="display:none" data-payment-open="jp">
                    {include file="$modulePath/views/templates/front/applePay16.tpl"}
                </div>
            </div>
        </div>
    {/if}
    ...
    {if $separateTwistoSlice == true}
        <div class="row">
            <div class="col-xs-12">
                <p class="payment_module">
                    <a class="payu payu_twisto_slice"
                       href="{$creditPayLaterTwistoSliceActionUrl|escape:'htmlall':'UTF-8'}"
